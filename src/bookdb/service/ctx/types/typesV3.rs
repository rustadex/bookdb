...
// ============================================================================
// V3 CONTEXT CHAIN TYPES (with Deref for automatic coercion)
// ============================================================================
...
/// Specialized variable context chain - behaves as ContextChainV3 via Deref
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]  
pub struct VarContextChain {
    /// Inner ContextChainV3 for automatic coercion
    inner: ContextChainV3,
    /// Quick access fields for convenience
...
/// Specialized document context chain - behaves as ContextChainV3 via Deref
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
// ============================================================================
// DEREF IMPLEMENTATIONS (Automatic Coercion)
// ============================================================================

use std::ops::Deref;

impl Deref for VarContextChain {
    type Target = ContextChainV3;
...
impl Deref for DocContextChain {
    type Target = ContextChainV3;
